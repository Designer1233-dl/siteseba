...
const publicCommunity = c => ({id:c.id,type:c.type,name:c.name,username:c.username,description:c.description||'',avatar:c.avatar||'',ownerId:c.ownerId,memberCount:(c.members||[]).length,verified:Boolean(c.verified),verifiedType:c.verifiedType||c.type,createdAt:c.createdAt});
